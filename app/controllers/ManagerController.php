...
class ManagerController extends BaseController{
	...
	public function generateSmsList(){
			Fpdf::AddPage();
                ...
                Fpdf::SetTextColor(255);
                Fpdf::SetFont('Courier','B');
                Fpdf::Cell(65, 10, "First Name" , 1, 0, 'L', true);
                Fpdf::Cell(65, 10, "Last Name" , 1, 0, 'L', true);
                Fpdf::Cell(65, 10, "Contact Number" , 1, 0, 'L', true);
                Fpdf::Ln();
                ...
                $users = $this->user->getSmsManagerView($id, $location_id);
                Fpdf::SetFillColor(255);
                Fpdf::SetTextColor(0);

                foreach($users as $user){
                	Fpdf::Cell(65, 6, $user->first_name, 1, 0, 'L', true);
                	Fpdf::Cell(65, 6, $user->last_name, 1, 0, 'L', true);
                	Fpdf::Cell(65, 6, $user->contact_number, 1, 0, 'L', true);
                	Fpdf::Ln();
                }
